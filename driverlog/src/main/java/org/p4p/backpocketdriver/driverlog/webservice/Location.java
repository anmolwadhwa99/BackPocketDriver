 ...
 * <p>
 * 
 * Note: This is a quick and dirty port of Android's Location class. We are using this class here to take advantage of its ability to
...
public class Location /* implements Parcelable */{
	...
	public void makeComplete() {
		...
		if (mElapsedRealtimeNanos == 0) {
			...
			mElapsedRealtimeNanos = System.nanoTime();
		}
	}

	/**
	 * Returns additional provider-specific information about the location fix as a Bundle. The keys and values are
	 * determined by the provider. If no additional information is available, null is returned.
	 * 
	 * <p>
	 * A number of common key/value pairs are listed below. Providers that use any of the keys on this list must provide
...
//	}
	...
	/**
	 * Returns one of the optional extra {@link Location}s that can be attached to this Location.
	 * 
	 * @param key
	 *            the key associated with the desired extra Location
	 ...
	 * 
	 * @param key
	 *            the key associated with the Location extra
	 * @param location
	 *            the Location to attach
	 * @hide
	 */
