 ...
 */
public class JourneyStatistics implements Serializable{
    ...
    private int journeyStatisticsId;
    ...
    public void setDistanceTravelled_Hundred_total(int distanceTravelled_Hundred_total) {
    ...
    public void setDistanceTravelled_Miscellaneous_total(int distanceTravelled_Miscellaneous_total) {
    ...
    public void setDistanceTravelled_motorway_total(int distanceTravelled_motorway_total) {
    ...
    public void setDistanceTravelled_Hundred_night(int distanceTravelled_Hundred_night) {
    ...
    public void setDistanceTravelled_Miscellaneous_day(int distanceTravelled_Miscellaneous_day) {
    ...
    public void setDistanceTravelled_Miscellaneous_night(int distanceTravelled_Miscellaneous_night) {
    ...
    public void setDistanceTravelled_motorway_night(int distanceTravelled_motorway_night) {
    ...
    public int getJourneyStatisticsId() {
        return journeyStatisticsId;
    }

    public void setJourneyStatisticsId(int journeyStatisticsId) {
        this.journeyStatisticsId = journeyStatisticsId;
    }
